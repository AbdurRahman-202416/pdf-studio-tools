...
export const toolRegistry: ToolEntry[] = [
  ...
  },
  {
    ...
    displayName: "Compress PDF to 200KB",
    primaryKeyword: "compress pdf to 200kb",
    cardCopy: "Hit a 200KB target while keeping scans readable.",
    metaDescription:
      "Compress PDF to 200KB online free. Target-size compressor that keeps scanned text legible - ideal for job portals, visa forms, and 200KB upload limits. No signup, no watermark.",
    relatedKeywords: [
    ...
    relatedSlugs: ["compress-pdf", "compress-pdf-to-100kb", "compress-pdf-to-500kb"],
    seoCopy:
      "Compress PDF to 200KB online free. The 200KB target is the sweet spot for online applications - small enough for strict portals, large enough to keep scanned IDs and forms legible. Works on any PDF in any language; no signup, no watermark.",
    region: "global",
  },
  {
    slug: "compress-pdf-to-500kb",
    displayName: "Compress PDF to 500KB",
    primaryKeyword: "compress pdf to 500kb",
    cardCopy: "Drop a heavy PDF under 500KB with minimal quality loss.",
    metaDescription:
      "Compress PDF to 500KB online free. Shrink large or image-heavy PDFs under a 500KB limit while keeping high quality. No signup, no watermark, files auto-delete in 1 hour.",
    relatedKeywords: [
      "reduce pdf size to 500kb",
      "pdf to 500kb online",
      "compress pdf under 500kb",
      "500kb pdf compressor",
      "compress large pdf to 500kb",
      "shrink pdf to 500kb high quality",
    ],
    category: "optimize",
    iconName: "Target",
    backendEndpoint: "/tools/compress/target-size",
    faqs: [
      { q: "When is 500KB the right target?", a: "When you have an image-heavy or multi-page PDF and the portal allows up to 500KB. It preserves far more detail than 100-200KB targets." },
      { q: "Can I compress a scanned booklet to 500KB?", a: "Often yes. Very long photo scans may settle slightly above 500KB - the tool tells you the smallest size it could reach." },
      { q: "Does compression reduce print quality?", a: "Minimally at 500KB. Text stays sharp; photos keep good detail for on-screen and standard printing." },
      { q: "Any file limits?", a: "Upload up to 100 MB per PDF. No daily limit, no account." },
    ],
    howTo: [
      { name: "Upload your PDF", text: "Drop a large or image-heavy PDF onto the upload zone." },
      { name: "Confirm the 500KB target", text: "500KB is pre-selected; pick another target if your upload limit differs." },
      { name: "Download", text: "Get a clean, watermark-free PDF sized for your limit." },
    ],
    relatedSlugs: ["compress-pdf", "compress-pdf-to-200kb", "compress-pdf-to-1mb"],
    seoCopy:
      "Compress PDF to 500KB online free. A 500KB target suits image-heavy reports, scanned booklets, and portfolios that need to stay under half a megabyte without looking degraded. No signup, no watermark - works on any PDF.",
    region: "global",
  },
  {
    slug: "compress-pdf-to-1mb",
    displayName: "Compress PDF to 1MB",
    primaryKeyword: "compress pdf to 1mb",
    cardCopy: "Get any PDF under 1MB while keeping it sharp.",
    metaDescription:
      "Compress PDF to 1MB online free. Reduce large PDFs under a 1MB email or upload limit with near-original quality. No signup, no watermark, files auto-delete in 1 hour.",
    relatedKeywords: [
    ...
    relatedSlugs: ["compress-pdf", "compress-pdf-to-500kb", "merge-pdf"],
    seoCopy:
      "Compress PDF to 1MB online free. The 1MB target keeps PDFs nearly indistinguishable from the original while clearing common email and upload limits. Works on any PDF in any language; no signup, no watermark.",
    region: "global",
  },
  {
    slug: "merge-pdf",
