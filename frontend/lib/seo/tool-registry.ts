...
export const toolRegistry: ToolEntry[] = [
  {
    ...
    metaDescription:
      "Compress PDF online free without losing quality. Reduce PDF file size by up to 90% — no signup, no watermark, files auto-delete.",
    relatedKeywords: [
    ...
    faqs: [
      ...
      { q: "Is the online PDF compressor really free?", a: "Yes — every compression is free, with no daily limit, no signup, and no watermark on the output." },
      { q: "Does it work with Bangla PDFs?", a: "Yes — compression preserves Bangla, Arabic, Hindi, and CJK fonts. Text remains selectable in the compressed output." },
    ],
    howTo: [
      { name: "Upload your PDF", text: "Drop a PDF file (up to 100 MB) onto the upload zone or click to browse." },
      { name: "Pick a compression level", text: "Choose Light (best quality), Balanced (recommended), or Maximum (smallest size)." },
      { name: "Download the result", text: "Click Compress, wait a few seconds, then download your smaller PDF." },
    ],
    relatedSlugs: ["compress-pdf-to-100kb", "merge-pdf", "pdf-to-jpg"],
    seoCopy:
      "Compress PDF online for free with PDF Studio. Reduce PDF file size for email attachments, government portals, college applications, and storage limits — all in your browser, with files automatically deleted after one hour. Works perfectly with English, Bangla, Arabic, and 100+ other languages.",
    region: "global",
  },
  {
